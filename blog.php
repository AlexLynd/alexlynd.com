        ...
        <div class="" >
            ...
            <div class="uk-section-default">
                <div class="uk-container uk-container-xlarge uk-padding-large">
                    <button class="uk-button uk-button-default" type="button">Sort By Tag <span uk-icon="icon: triangle-down"></span></button>
                <div uk-dropdown>
                    ...
                    <button class="uk-button uk-button-default" type="button">Sort by Date <span uk-icon="icon: triangle-down"></span></button>
                <div uk-dropdown>
                    <ul class="uk-nav uk-dropdown-nav">
                ...
                <div class="uk-child-width-1-2@s uk-child-width-1-3@m uk-child-width-1-4@l  uk-margin uk-margin-large-top" uk-grid="masonry: true">
                      
                        <div>
                            <div class="uk-card uk-card-default uk-card-body uk-padding uk-padding-remove">
                                ...
                                <div class="uk-padding uk-padding-small blog">
                                    <h3 class="uk-margin uk-margin-small" style="font-weight: 600; font-family: 'Space Mono'!important;">AuditPi WarSkating Demo</h3>
                                    <p class="uk-margin uk-margin-small">The AuditPi is a platform I created to demonstrate portable hacking.  This is a test</p>
                                    <p class="date">[12 Feb 20]</p>
                        ...
                        <div>
                            <div class="uk-card uk-card-default uk-card-body uk-padding uk-padding-remove">
                                ...
                                <div class="uk-padding uk-padding-small blog">
                                    <h3 class="uk-margin uk-margin-small" style="font-weight: 600; font-family: 'Space Mono'!important;">How I Created the CreepDetector</h3>
                        ...
                        <div>
                            <div class="uk-card uk-card-default uk-card-body uk-padding uk-padding-remove">
                                <div class="uk-cover-container uk-height-medium uk-animation-toggle" tabindex="0">
                                    <img src="/projects/ESP-DriveBy/img/EDB1.jpg" class=" uk-animation-kenburns" alt="" uk-cover uk-img>
                                </div>
                                <div class="uk-padding uk-padding-small blog">
